...
//End Auth
	Route::get('/daily', 'NewsController@daiLy')->name('daily');
	Route::get('/chinhsach', 'NewsController@chinhsach')->name('chinhsach');
	//Route::get('/gioithieu', 'NewsController@chinhsach')->name('chinhsach');
	Route::get('/gioithieu.html', 'NewsController@gioithieu')->name('gioithieu');
	Route::get('/gioithieu/{name}_{id}.html', 'NewsController@gioithieuDetail')
		->where(['id' => '[0-9]+'])->name('gioithieuDetail');
	
	Route::get('/tintuc.html', 'NewsController@tintuc')->name('tintuc');
	Route::get('/tintuc/{name}_{id}.html', 'NewsController@tintucDetail')
		->where(['id' => '[0-9]+'])->name('tintucDetail');
	Route::get('/video.html', 'VideoController@video')->name('video');
	Route::get('/video/{name}_{id}.html', 'VideoController@videoDetail')
		->where(['id' => '[0-9]+'])->name('videoDetail');
//Customer profile
