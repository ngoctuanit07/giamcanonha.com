        ...
        <div class="list">
            <div class="left content_left">
                <div class="title_dm"><h1 class="title_h1 name post-title entry-title" itemprop="itemReviewed"
                                          itemscope="" itemtype="http://schema.org/Thing"><a href="/Ve-Matxi-SG/"
                                                                                             title="Về Matxi S.G"><span
                                    itemprop="name">Về Matxi S.G</span></a><br/><span class="border"></span></h1></div>
                <div class="page_text">
                </div>
                <div class="list_news">
                    <div class="wrap_all">
                        @foreach ($newsGioiThieu as $newsDetail)
                            <div class="left story_news">
                                ...
                                <div class="story_thumb">
                                    <a href="{{ $newsDetail->getGioiThieuUrl() }}"
            ...
            <div class="right content_right">
                <div class="title_r"><h2><a href="/gioithieu.html">Về
