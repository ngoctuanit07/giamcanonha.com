 ...
 */
    ...
    public function getAllProduct(){
    	$query = DB::table('shop_product as product')->join('shop_product_description as productdetail','product.id', '=', 'productdetail.product_id')->where('productdetail.lang_id','=',2)->get();
    	return $query;
	}
